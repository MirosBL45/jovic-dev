...
export const aboutDataText = [
  ...
  'Specializing in React and Next.js, I leverage these cutting-edge technologies to bring web projects to life. React, renowned for its component-based architecture, allows me to build modular and reusable UI elements, ensuring a streamlined development process.',
  'Next.js, on the other hand, enhances the performance of web applications through server-side rendering and simplified routing. This not only results in faster load times but also contributes to a smoother and more engaging user experience.',
